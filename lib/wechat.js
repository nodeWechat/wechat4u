...
exports = module.exports = class wechat {
  ...
  checkLogin() {
    ...
    return this.axios({
      ...
      if (code == 200) {
        ...
        if (this[webProp].baseUri[10] == 2) {
          this[webProp].webpushUri = 'webpush2'
        } else {
          this[webProp].webpushUri = 'webpush'
        }
        return code
      } else if (code == 408) {
        throw new Error(code)
  ...
  syncCheck() {
    let url = `https://${this[webProp].webpushUri}.weixin.qq.com/cgi-bin/mmwebwx-bin/synccheck`
