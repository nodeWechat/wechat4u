...
export default function ConfFactory(url) {
  let baseUrl = url || 'https://wx.qq.com/cgi-bin/mmwebwx-bin',
    loginUrl = "login.weixin.qq.com",
    fileUrl = "file.wx.qq.com",
    pushUrl = "webpush.weixin.qq.com";
  baseUrl.indexOf("wx2.qq.com") > -1 ? (loginUrl = "login.wx2.qq.com", fileUrl = "file.wx2.qq.com",
    pushUrl =
    "webpush.wx2.qq.com") : baseUrl.indexOf("wx8.qq.com") > -1 ? (loginUrl = "login.wx8.qq.com",
    fileUrl =
    "file.wx8.qq.com", pushUrl = "webpush.wx8.qq.com") : baseUrl.indexOf("qq.com") > -1 ? (
    loginUrl =
    "login.wx.qq.com", fileUrl = "file.wx.qq.com", pushUrl = "webpush.wx.qq.com") : baseUrl.indexOf(
    "web2.wechat.com") > -1 ? (loginUrl = "login.web2.wechat.com", fileUrl =
    "file.web2.wechat.com", pushUrl =
    "webpush.web2.wechat.com") : baseUrl.indexOf("wechat.com") > -1 && (loginUrl =
  ...
  let a = {
    ...
    API_jsLogin: "https://" + loginUrl + "/jslogin?appid=wx782c26e4c19acffb&fun=new&lang=" + r,
    ...
    API_webwxpreview: baseUrl + "/webwxpreview",
    API_webwxinit: baseUrl + "/webwxinit",
    API_webwxgetcontact: baseUrl + "/webwxgetcontact",
    API_webwxsync: baseUrl + "/webwxsync",
    API_webwxbatchgetcontact: baseUrl + "/webwxbatchgetcontact",
    API_webwxgeticon: baseUrl + "/webwxgeticon",
    API_webwxsendmsg: baseUrl + "/webwxsendmsg",
    API_webwxsendmsgimg: baseUrl + "/webwxsendmsgimg",
    API_webwxsendmsgvedio: baseUrl + "/webwxsendvideomsg",
    API_webwxsendemoticon: baseUrl + "/webwxsendemoticon",
    API_webwxsendappmsg: baseUrl + "/webwxsendappmsg",
    API_webwxgetheadimg: baseUrl + "/webwxgetheadimg",
    API_webwxgetmsgimg: baseUrl + "/webwxgetmsgimg",
    API_webwxgetmedia: baseUrl + "/webwxgetmedia",
    API_webwxgetvideo: baseUrl + "/webwxgetvideo",
    API_webwxlogout: baseUrl + "/webwxlogout",
    API_webwxgetvoice: baseUrl + "/webwxgetvoice",
    API_webwxupdatechatroom: baseUrl + "/webwxupdatechatroom",
    API_webwxcreatechatroom: baseUrl + "/webwxcreatechatroom",
    API_webwxstatusnotify: baseUrl + "/webwxstatusnotify",
    API_webwxcheckurl: baseUrl + "/webwxcheckurl",
    API_webwxverifyuser: baseUrl + "/webwxverifyuser",
    API_webwxfeedback: baseUrl + "/webwxsendfeedback",
    API_webwxreport: baseUrl + "/webwxstatreport",
    API_webwxsearch: baseUrl + "/webwxsearchcontact",
    API_webwxoplog: baseUrl + "/webwxoplog",
    API_checkupload: baseUrl + "/webwxcheckupload",
    oplogCmdId: {
      TOPCONTACT: 3,
      MODREMARKNAME: 2
    },
