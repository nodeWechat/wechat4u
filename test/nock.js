...
nock('https://wx2.qq.com')
  .post('/cgi-bin/mmwebwx-bin/webwxsync', data => true)
  .query(data => true)
  .times(2)
  .reply(200, fs.readFileSync(path.resolve(__dirname,'./response/webwxsync'),'utf-8'))

nock('https://wx2.qq.com')
  .post('/cgi-bin/mmwebwx-bin/webwxlogout', data => true)
  .query(data => true)
  .reply(200, '')
